<?php  
    ...
    if(isset($_POST['update'])) {
        ...
        if (empty($name) && empty($email)) {
            ...
            // Update sql
            $updateSql = "UPDATE users SET name = '$name' , email = '$email' WHERE id = $fetch";
